...
最初にユーザーが指定したCAD画像1点と録画5本を、既存プロジェクトの原本とSHAで照合して掲載しました。第30回A/Bの14秒比較MP4を2本と、対応するGIF2点を追加しました。公開実録画・比較MP4は41本から43本になりました。GIFはMP4本数へ加算しません。C動画は今回掲載せず、非公開で回収・生成を続けます。 最新の掲載対象は第30回A/Bで、第27回A/Bの動画も履歴に保持します。CAD画像1点と実測チャート再描画MP4は別枠です。[README](../README.md#映像でたどる開発履歴)の最初・よちよち歩き・第5・10・15・20・25回のダイジェスト7件も保持します。14秒比較は表示用の抜粋で、各欄の全評価時間とは区別します。
