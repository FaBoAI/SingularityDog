...
2026-09-17現在、数値結果は[第37回](l32-evaluation.md)まで公開しています。新しい録画の掲載は第31回A/B/Cまでで、全47本の公開録画・比較MP4を保持しています。第32〜37回の動画を過去動画で代用していません。

READMEの節目は[1・2・5・10・15・20・25・30・35・40](milestone-history.md)です。第1・2回は公開動画なし、第40回は未実施。最初に掲載した旧保存番号2197の映像は、第1回の映像とは別です。下の記録は各時点の掲載履歴です。

最初に指定されたCAD画像1点と録画5本から、選択した各回の結果・比較を追加してきました。第31回A/B/Cの14秒比較MP4とGIFを各3点追加した際に、公開実録画・比較MP4は44→47本となりました。GIFはMP4本数へ加算しません。最新は第31回ABC、第30回ABCと第27回A/Bも履歴に保持します。CAD画像1点と実測チャート再描画MP4は別枠です。[README](../README.md#映像でたどる開発履歴)の最初・よちよち歩き・第5・10・15・20・25回のダイジェスト7件も維持します。14秒比較は表示用の抜粋で、各欄の全評価時間とは区別します。

第32回は[評価集計と比較図](l27-evaluation.md)を公開しました。動画は未回収・未掲載で、最新の公開動画は第31回のままです。現在の32試行と録画・比較MP4の47本、実測チャート再描画MP4の1本を別集計します。
...
これらは開発順を示す参考履歴で、モデル・指令・物理設定が異なります。旧2197・旧250を現在の直近32回へ混ぜず、H04・L00を二重に数えません。B0とCAD画像も改善回数へ加算しません。2197・250・599・249は保存番号で、改善ループ回数とは別です。全開発の通算回数は引き続き未確定です。
