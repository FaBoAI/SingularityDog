...
最初に指定されたCAD画像1点と録画5本から、選択した各回の結果・比較を追加してきました。第31回A/B/Cの14秒比較MP4とGIFを各3点追加した際に、公開実録画・比較MP4は44→47本となりました。GIFはMP4本数へ加算しません。最新は第31回ABC、第30回ABCと第27回A/Bも履歴に保持します。CAD画像1点と実測チャート再描画MP4は別枠です。以前のダイジェストに掲載した最初・よちよち歩き・第5・10・15・20・25回のメディアは、この動画履歴に保持します。14秒比較は表示用の抜粋で、各欄の全評価時間とは区別します。
