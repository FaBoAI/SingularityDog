...
最初にユーザーが指定したCAD画像1点と録画5本を、既存プロジェクトの原本とSHAで照合して掲載しました。その後の結果動画を含め、現在は実録画・比較動画22本を公開しています。CAD画像は1点、実測チャートの再描画MP4は別枠です。ファイル名だけで実験を推測していません。[READMEの動画一覧](../README.md#映像でたどる開発履歴)から元MP4を開け、GIFを添えた項目は全区間のプレビューでも確認できます。
...
[最終model499・24秒MP4](media/l15-model499-stationary-prone.mp4) · [第20回の条件・測定値・未達](l15-evaluation.md)
