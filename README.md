...
**9動作を3×3で比較できます。** 上2段は6方向の移動、下段は伏せ・挨拶・お座りです。

<img src="docs/media/l20-nine-motions.gif" width="720" alt="第25回・9動作の最終評価を3×3に並べた全36秒。未達を含み、各録画の終了後は黒いパネルへ切り替わります。">

[9分割MP4・36秒](docs/media/l20-nine-motions.mp4)
