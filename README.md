...
## 最新の公開動画：第30回A/B/Cを3×3で比較

第30回の各条件で評価した9動作を、**各14秒**で表示します。英語の動作名はシミュレーション画面の左上、終了した枠は最後のカラー画像を保持します。移動6方向と伏せは先頭12秒、手振りとお座りは第1周期の途中の14秒までです。

**条件A** — 保守的な追加学習。全長評価は7/9合格。伏せの第2保持は1.9500秒で未達。

<img src="docs/media/l25-a-nine-motions.gif" width="720" alt="第30回・条件Aの9動作を3×3で14秒表示。全長評価で7/9合格、終了した枠はカラー静止。">

[条件AのMP4・14秒](docs/media/l25-a-nine-motions.mp4)

**条件B** — 伏せの方位・挨拶の足高さと方位の余裕を重視。全長評価は7/9合格。伏せ保持と四足復帰は各2秒×2を達成し、位置・方位は未達。

<img src="docs/media/l25-b-nine-motions.gif" width="720" alt="第30回・条件Bの9動作を3×3で14秒表示。全長評価で7/9合格、伏せと挨拶は総合未達。">

[条件BのMP4・14秒](docs/media/l25-b-nine-motions.mp4)

**条件C** — Bに伏せの支持余裕と挨拶の位置ずれへの報酬を追加。全長評価は7/9合格。伏せ保持と四足復帰は各2秒×2を達成しましたが、伏せの最大位置ずれ57.52mm・方位ずれ21.38°、挨拶の位置ずれ63.02mmが残課題です。

<img src="docs/media/l25-c-nine-motions.gif" width="720" alt="第30回・条件Cの9動作を3×3で14秒表示。全長評価で7/9合格、伏せと挨拶は総合未達。">

[条件CのMP4・14秒](docs/media/l25-c-nine-motions.mp4)

合否は14秒の抜粋ではなく、移動各12秒・伏せ24秒・挨拶36秒・お座り32秒の全評価区間で判定しています。短い枠の静止時間は成功保持時間に含めません。

[第30回の結果・条件差・残課題](docs/l25-evaluation.md) · [第29回の結果](docs/l24-evaluation.md) · [第27回A/Bの動画](docs/video-history.md)
...
READMEでは**最初・よちよち歩き・第5・10・15・20・25回の動画ダイジェスト**を掲載します。公開している録画・比較動画44本とCAD画像1点は引き続き保持し、[全動画の履歴](docs/video-history.md)と[30回の実行・評価履歴](docs/improvement-loops.md)からたどれます。改善回数30回と動画本数44本は別の集計です。
