...
C条件の動画は回収・検査中です。A/B/Cの数値結果は[第30回の評価記録](docs/l25-evaluation.md)に掲載しています。
...
READMEでは**最初・よちよち歩き・第5・10・15・20・25回の動画ダイジェスト**を掲載します。公開している録画・比較動画43本とCAD画像1点は引き続き保持し、[全動画の履歴](docs/video-history.md)と[30回の実行・評価履歴](docs/improvement-loops.md)からたどれます。改善回数30回と動画本数43本は別の集計です。
