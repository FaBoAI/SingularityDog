...
READMEでは**最初・よちよち歩き・第5・10・15・20・25回の動画ダイジェスト**を掲載します。公開している録画・比較動画41本とCAD画像1点は引き続き保持し、[全動画の履歴](docs/video-history.md)と[28回の実行・評価履歴](docs/improvement-loops.md)からたどれます。改善回数28回と動画本数41本は別の集計です。
