...
**9動作を3×3で比較できます。** 上2段は6方向の移動、下段は伏せ・挨拶・お座りです。下段は最初の1周期を表示し、全体は18秒です。合否は全評価区間の結果です。

<img src="docs/media/l20-nine-motions.gif" width="720" alt="第25回・9動作の18秒比較。下段3動作は最初の1周期。終了した表示区間は最後のフレームをグレースケールで静止表示します。合否は全評価区間の結果です。">

[9分割MP4・18秒](docs/media/l20-nine-motions.mp4)
